...
- [ ] 1.6 README Quick Start 与 `main` 一致  
...
| 仓库 | 说明 | 端口 |
| ---- | ---- | ---- |
| [qualitest](https://github.com/qualitest-hq/qualitest) | 主平台（**已含** Web/桌面 `qualitest-ui/`） | 8080 / UI 5173 |
| [qualitest-demo](https://github.com/qualitest-hq/qualitest-demo) | 接口测试靶场（含 `/test-support` 端点） | 8081 |
