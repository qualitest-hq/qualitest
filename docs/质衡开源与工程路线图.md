...
| 1.6 | README Quick Start | ~~与 `main` 一致；默认 `admin` / `admin123`、端口表~~ **已完成**（Compose `:80` / 本机 `8080`+`5173`；插件 Compose 用 `/prod-api`）                      | 0.5d |
...
- [x] 1.6 README Quick Start 与 `main` 一致（默认账号、端口表、Compose / 本机步骤）  
...
- [ ] 3.3～3.4、3.6 CI / deploy.md / Issue·PR 模板  
