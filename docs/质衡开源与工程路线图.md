...
| 3.2 | ~~**英文全文档**~~ | **已完成**：`README.en.md`；`docs/mcp.en.md` / `deploy.en.md` / `test-flow-nodes.en.md` | — |
| 3.3 | 中文文档补全 | ~~`docs/test-flow-nodes.md`~~ **已完成**；FAQ 仍待扩写 | 0.5d |
...
| 仓库 | 版本策略 |
| ---- | -------- |
| `qualitest` | 功能与 UI 同步 semver；`v2.0.0` 为大技术债版本 |
| `qualitest-demo` | 可略滞后；已含 `/test-support` |
| `qualitest-intellij-plugin` | 独立版本；IDE 大版本后 1～2 周跟进 |
...
- [ ] 3.1 插件市场上架
- [x] 3.2 英文全文档（`README.en.md` + mcp / deploy / test-flow-nodes `.en.md`）
- [x] 3.3′ `docs/test-flow-nodes.md`（FAQ 仍待扩写）
...
| 文档 | 作用 |
| ---- | ---- |
| [`docs/v1.0-周末开源冲刺手册.md`](./v1.0-周末开源冲刺手册.md) | 周末 1.5 天冲刺：Cursor 自动测（T1/T2/T3）+ 公开收尾 |
