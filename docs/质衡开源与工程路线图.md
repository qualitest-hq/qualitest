...
| 3.5 | `CHANGELOG.md`                  | ~~从 v1.0.0 起维护~~ **已完成**（根目录 `CHANGELOG.md`；首发章节可作 Release Note）                                                         | — |
| 3.6 | Issue / PR 模板                   | `.github/ISSUE_TEMPLATE/`、PR template                                | 0.5d |
| 3.7 | `v1.2.0` Release                | 说明单仓结构 + CI / fixture 变更                                              | 0.5d |
...
- [ ] 1.7、1.11、1.12 GIF、Release、首发文发出  
...
- [x] 3.5 `CHANGELOG.md`（自 v1.0.0）  
- [ ] 3.2 flow fixture 单一来源  
- [ ] 3.3～3.4、3.6～3.7 CI / deploy.md / 模板 / Release  
