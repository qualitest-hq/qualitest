...
**After toggling either switch you must reconnect or refresh MCP** — editors often keep the old tool list (the server does not push tool-list changes). Without auto-write, edit on Web AI → Staging → Save.
