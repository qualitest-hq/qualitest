...
export const ui = {
  zh: {
    ...
    mcpAutopilotTitle: "造流 / 跑通",
    mcpAutopilotDesc: "开启「允许 MCP 全自动写流」后，Cursor 创建、提交并运行测试流，Web 画布同步。",
    mcpAutopilotAlt: "MCP 造流：在 Cursor 中创建/提交测试流并运行，Web 画布同步",
    mcpAutopilotPlaceholder: "录制后放入 site/public/images/demo-mcp-autopilot.gif（与 docs/images/ 同名）",
    ecoTitle: "生态仓库",
  ...
  en: {
    ...
    mcpAutopilotTitle: "Create / run",
    mcpAutopilotDesc: "With autopilot write on, Cursor creates, submits, and runs flows; the Web canvas syncs.",
    mcpAutopilotAlt: "MCP autopilot: create/submit/run a flow in Cursor; Web canvas syncs",
    mcpAutopilotPlaceholder: "Add site/public/images/demo-mcp-autopilot.gif (same name as docs/images/)",
    ecoTitle: "Ecosystem",
