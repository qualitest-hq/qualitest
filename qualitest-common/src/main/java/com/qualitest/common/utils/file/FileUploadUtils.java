package com.qualitest.common.utils.file;

import com.qualitest.common.config.QualitestConfig;
import com.qualitest.common.constant.Constants;
import com.qualitest.common.exception.file.FileNameLengthLimitExceededException;
import com.qualitest.common.exception.file.FileSizeLimitExceededException;
import com.qualitest.common.exception.file.InvalidExtensionException;
...
import com.qualitest.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = QualitestConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = QualitestConfig.getProfile().length() + 1;
