package com.qualitest.common.core.text;
...
public class Convert {
    ...
    public static List<Integer> toIntList(String str, String split) {
        ...
        return Arrays.stream(str.split(split)).map(s -> toInt(s.trim(), 0)).collect(Collectors.toList());
    }
    ...
    public static List<Long> toLongList(String split, String str) {
        ...
        return Arrays.stream(str.split(split)).map(Long::valueOf).collect(Collectors.toList());
    }
