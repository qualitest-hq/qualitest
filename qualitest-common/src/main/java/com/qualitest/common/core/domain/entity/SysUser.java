package com.qualitest.common.core.domain.entity;
...
import com.qualitest.common.xss.Xss;
...
@NoArgsConstructor
@AllArgsConstructor
@ToString(callSuper = true, exclude = {"roles", "roleIds", "postIds", "roleId", "excludeUserIds"})
