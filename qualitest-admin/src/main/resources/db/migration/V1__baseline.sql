...
-- 保留：菜单/字典/参数、演示账号与角色、内置鉴权模板、内置 AI 厂商与快捷提示词
...
-- ----------------------------
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000001, 'Deepseek', 0, 'deepseek', 'openai_compatible', 'openai_models', 'https://api.deepseek.com',
        NULL, 1, 10, NULL, 0, '2026-06-23 11:42:53', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000002, 'OpenAI', 1, 'openai', 'openai_compatible', 'openai_models', 'https://api.openai.com/v1',
        NULL, 0, 20, NULL, 0, '2026-06-23 11:42:53', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000003, '硅基流动', 1, 'siliconflow', 'openai_compatible', 'openai_models',
        'https://api.siliconflow.cn/v1', NULL, 0, 30, NULL, 0, '2026-06-23 11:42:54', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000004, 'Anthropic', 1, 'anthropic', 'anthropic_compatible', 'anthropic_models',
        'https://api.anthropic.com', NULL, 0, 40, NULL, 0, '2026-06-23 11:42:54', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000005, 'Ollama', 1, 'ollama', 'openai_compatible', 'ollama_tags', 'http://127.0.0.1:11434/v1',
        NULL, 0, 50, NULL, 0, '2026-06-23 11:42:55', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000006, 'Moonshot（Kimi）', 1, 'moonshot', 'openai_compatible', 'openai_models',
        'https://api.moonshot.cn/v1', NULL, 0, 60, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000007, '智谱 AI', 1, 'zhipu', 'openai_compatible', 'openai_models',
        'https://open.bigmodel.cn/api/paas/v4', NULL, 0, 70, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000008, '通义千问', 1, 'qwen', 'openai_compatible', 'openai_models',
        'https://dashscope.aliyuncs.com/compatible-mode/v1', NULL, 0, 80, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000009, 'MiniMax', 1, 'minimax', 'openai_compatible', 'openai_models',
        'https://api.minimax.chat/v1', NULL, 0, 90, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000010, '火山引擎（豆包）', 1, 'volcengine', 'openai_compatible', 'openai_models',
        'https://ark.cn-beijing.volces.com/api/v3', NULL, 0, 100, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000011, '百川智能', 1, 'baichuan', 'openai_compatible', 'openai_models',
        'https://api.baichuan-ai.com/v1', NULL, 0, 110, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000012, '零一万物', 1, 'yi', 'openai_compatible', 'openai_models',
        'https://api.lingyiwanwu.com/v1', NULL, 0, 120, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000013, '阶跃星辰', 1, 'stepfun', 'openai_compatible', 'openai_models',
        'https://api.stepfun.com/v1', NULL, 0, 130, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000014, '腾讯混元', 1, 'hunyuan', 'openai_compatible', 'openai_models',
        'https://api.hunyuan.cloud.tencent.com/v1', NULL, 0, 140, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000015, 'Google Gemini', 1, 'gemini', 'openai_compatible', 'openai_models',
        'https://generativelanguage.googleapis.com/v1beta/openai', NULL, 0, 150, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000016, 'Groq', 1, 'groq', 'openai_compatible', 'openai_models',
        'https://api.groq.com/openai/v1', NULL, 0, 160, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000017, 'Mistral AI', 1, 'mistral', 'openai_compatible', 'openai_models',
        'https://api.mistral.ai/v1', NULL, 0, 170, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000018, 'OpenRouter', 1, 'openrouter', 'openai_compatible', 'openai_models',
        'https://openrouter.ai/api/v1', NULL, 0, 180, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000019, 'Together AI', 1, 'together', 'openai_compatible', 'openai_models',
        'https://api.together.xyz/v1', NULL, 0, 190, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000020, 'Fireworks AI', 1, 'fireworks', 'openai_compatible', 'openai_models',
        'https://api.fireworks.ai/inference/v1', NULL, 0, 200, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000021, 'Azure OpenAI', 1, 'azure', 'openai_compatible', 'openai_models', '', NULL, 0, 210, NULL,
        0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000022, 'Perplexity', 1, 'perplexity', 'openai_compatible', 'openai_models',
        'https://api.perplexity.ai', NULL, 0, 220, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000023, 'xAI', 1, 'xai', 'openai_compatible', 'openai_models', 'https://api.x.ai/v1', NULL, 0, 230,
        NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000024, '自定义 OpenAI 兼容', 1, 'custom_openai', 'openai_compatible', 'openai_models', '', NULL,
        0, 240, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000025, '自定义（Anthropic 兼容）', 1, 'custom_anthropic', 'anthropic_compatible',
        'anthropic_models', '', NULL, 0, 250, NULL, 0, '2026-06-23 11:42:56', NULL);
INSERT INTO `ai_llm_vendor`
VALUES (2067000000000000026, '自定义（无列表接口）', 1, 'custom_static', 'openai_compatible', 'none', '', NULL, 0, 260,
        NULL, 0, '2026-06-23 11:42:56', NULL);
...
VALUES (2070000000000000101, 'platform', NULL, 'test_flow_design', '从零搭建', '空画布或仅有 start',
        '搭建「{流程名称}」：\n1. {步骤描述}\n2. {步骤描述}\n\n需登录：Start 后挂登录子流，或开头只登录一次；关键步骤后加断言。',
        1, 1, 101, '从零搭建', 0, '2026-07-04 21:37:19', NULL);
INSERT INTO `ai_prompt_template`
VALUES (2070000000000000103, 'platform', NULL, 'test_flow_design', '预期业务拒绝', '失败路径，关业务 Code',
        '搭建「{流程名称}」失败路径：\n1. 绑定「{接口}」\n2. successCheck.mode=off\n3. 断言 http.body.code ≠ 成功码，或 msg 含「{拒绝文案}」\n\n测值用场景给定账号，勿用成功登录占位。',
        1, 1, 102, '从零搭建', 0, '2026-07-04 21:37:19', NULL);
INSERT INTO `ai_prompt_template`
VALUES (2070000000000000201, 'platform', NULL, 'test_flow_design', '末尾追加步骤', '画布已有节点',
        '在流末尾追加：{新步骤描述}。不要删除或修改现有节点。', 1, 1, 201, '扩展现有流', 0, '2026-07-04 21:37:19', NULL);
INSERT INTO `ai_prompt_template`
VALUES (2070000000000000501, 'platform', NULL, 'test_flow_design', 'Run 失败修复', '@Run 或步骤名',
        '@{Run:最近一次失败Run} 或步骤「{nodeName}」失败。分析参数、断言、extract 并修复，勿动无关节点。', 1, 1, 301,
        'Run 失败修复', 0, '2026-07-04 21:37:19', NULL);
INSERT INTO `ai_prompt_template`
VALUES (2070000000000000601, 'platform', NULL, 'test_flow_design', '插入登录子流', 'Start 后挂子流',
        '在 Start 后插入登录子流「{子流名}」，outputs 映射 flow.token 或 flow.adminToken。后续 HTTP 勿再登录。', 1, 1, 401,
        '子流编排', 0, '2026-07-04 21:37:19', NULL);
INSERT INTO `ai_prompt_template`
VALUES (2070000000000002103, 'platform', NULL, 'test_api_design', '测值用素材占位符', '{{asset.*}} 默认测值',
        '为缺省测值的参数补测值：优先 {{asset.key.field}}，环境相关用 {{env.*}}。勿写死密码或 Token。', 1, 1, 101, '补测值',
        0, '2026-07-22 13:51:11', NULL);
...
VALUES (1, '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'Y', 'admin', '2026-01-20 15:38:28', '',
        NULL, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow');
INSERT INTO `sys_config`
VALUES (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', '2026-01-20 15:38:28', '', NULL,
        '初始化密码 123456');
INSERT INTO `sys_config`
VALUES (3, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-light', 'Y', 'admin', '2026-01-20 15:38:28', 'admin',
        '2026-02-05 16:48:12', '深色主题theme-dark，浅色主题theme-light');
INSERT INTO `sys_config`
VALUES (4, '账号自助-验证码开关', 'sys.account.captchaEnabled', 'false', 'Y', 'admin', '2026-01-20 15:38:28', 'admin',
        '2026-04-07 15:11:45', '是否开启验证码功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2026-01-20 15:38:28',
        '', NULL, '是否开启注册用户功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (6, '用户登录-黑名单列表', 'sys.login.blackIPList', '', 'Y', 'admin', '2026-01-20 15:38:28', '', NULL,
        '设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
INSERT INTO `sys_config`
VALUES (7, '用户管理-初始密码修改策略', 'sys.account.initPasswordModify', '0', 'Y', 'admin', '2026-01-20 15:38:28',
        'admin', '2026-04-07 15:11:27',
        '0：初始密码修改策略关闭，没有任何提示，1：提醒用户，如果未修改初始密码，则在登录时就会提醒修改密码对话框');
INSERT INTO `sys_config`
VALUES (8, '用户管理-账号密码更新周期', 'sys.account.passwordValidateDays', '0', 'Y', 'admin', '2026-01-20 15:38:28',
        '', NULL,
...
VALUES (100, 0, '0', '质衡科技', 0, '质衡', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-20 15:38:20', '',
        NULL);
INSERT INTO `sys_dept`
VALUES (101, 100, '0,100', '测试部门', 1, '质衡', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-20 15:38:20',
        '', NULL);
...
VALUES (1, 1, '男', '0', 'sys_user_sex', '', '', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '性别男');
INSERT INTO `sys_dict_data`
VALUES (2, 2, '女', '1', 'sys_user_sex', '', '', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '性别女');
INSERT INTO `sys_dict_data`
VALUES (3, 3, '未知', '2', 'sys_user_sex', '', '', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '性别未知');
INSERT INTO `sys_dict_data`
VALUES (4, 1, '显示', '0', 'sys_show_hide', '', 'primary', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '显示菜单');
INSERT INTO `sys_dict_data`
VALUES (5, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '隐藏菜单');
INSERT INTO `sys_dict_data`
VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (8, 1, '正常', '0', 'sys_job_status', '', 'primary', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (9, 2, '暂停', '1', 'sys_job_status', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (10, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '默认分组');
INSERT INTO `sys_dict_data`
VALUES (11, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '系统分组');
INSERT INTO `sys_dict_data`
VALUES (12, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '系统默认是');
INSERT INTO `sys_dict_data`
VALUES (13, 2, '否', 'N', 'sys_yes_no', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '系统默认否');
INSERT INTO `sys_dict_data`
VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '通知');
INSERT INTO `sys_dict_data`
VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '公告');
INSERT INTO `sys_dict_data`
VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '关闭状态');
INSERT INTO `sys_dict_data`
VALUES (18, 99, '其他', '0', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '其他操作');
INSERT INTO `sys_dict_data`
VALUES (19, 1, '新增', '1', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '新增操作');
INSERT INTO `sys_dict_data`
VALUES (20, 2, '修改', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', '2026-01-20 15:38:27', '', NULL,
        '修改操作');
INSERT INTO `sys_dict_data`
VALUES (21, 3, '删除', '3', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '删除操作');
INSERT INTO `sys_dict_data`
VALUES (22, 4, '授权', '4', 'sys_oper_type', '', 'primary', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '授权操作');
INSERT INTO `sys_dict_data`
VALUES (23, 5, '导出', '5', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '导出操作');
INSERT INTO `sys_dict_data`
VALUES (24, 6, '导入', '6', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '导入操作');
INSERT INTO `sys_dict_data`
VALUES (25, 7, '强退', '7', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '强退操作');
INSERT INTO `sys_dict_data`
VALUES (26, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '生成操作');
INSERT INTO `sys_dict_data`
VALUES (27, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '清空操作');
INSERT INTO `sys_dict_data`
VALUES (28, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (29, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 'admin', '2026-01-20 15:38:28', '', NULL,
        '停用状态');
...
VALUES (1, '用户性别', 'sys_user_sex', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '用户性别列表');
INSERT INTO `sys_dict_type`
VALUES (2, '菜单状态', 'sys_show_hide', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '菜单状态列表');
INSERT INTO `sys_dict_type`
VALUES (3, '系统开关', 'sys_normal_disable', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '系统开关列表');
INSERT INTO `sys_dict_type`
VALUES (4, '任务状态', 'sys_job_status', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '任务状态列表');
INSERT INTO `sys_dict_type`
VALUES (5, '任务分组', 'sys_job_group', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '任务分组列表');
INSERT INTO `sys_dict_type`
VALUES (6, '系统是否', 'sys_yes_no', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '系统是否列表');
INSERT INTO `sys_dict_type`
VALUES (7, '通知类型', 'sys_notice_type', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '通知类型列表');
INSERT INTO `sys_dict_type`
VALUES (8, '通知状态', 'sys_notice_status', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '通知状态列表');
INSERT INTO `sys_dict_type`
VALUES (9, '操作类型', 'sys_oper_type', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '操作类型列表');
INSERT INTO `sys_dict_type`
VALUES (10, '系统状态', 'sys_common_status', '0', 'admin', '2026-01-20 15:38:27', '', NULL, '登录状态列表');
...
VALUES (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?',
        '3', '1', '1', 'admin', '2026-01-20 15:38:28', '', NULL, '');
...
VALUES (1060, '生成代码', 116, 6, '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:code', '#', 'admin',
        '2026-01-20 15:38:25', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2000, '测试管理', 0, 1, 'testManages', NULL, NULL, '', 1, 0, 'M', '0', '0', '', 'bug', 'admin',
        '2026-02-05 19:16:22', 'admin', '2026-07-04 21:17:34', '');
INSERT INTO `sys_menu`
VALUES (2001, '测试项目', 2000, 1, 'testProject', 'project/testProject/index', NULL, '', 1, 0, 'C', '0', '0',
        'project:testProject:list', 'test-project', 'admin', '2026-02-05 19:33:46', 'admin', '2026-02-09 19:58:19',
        '测试项目菜单');
INSERT INTO `sys_menu`
VALUES (2002, '测试项目查询', 2001, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'project:testProject:query', '#',
        'admin', '2026-02-05 19:33:46', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2003, '测试项目新增', 2001, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'project:testProject:add', '#', 'admin',
        '2026-02-05 19:33:46', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2004, '测试项目修改', 2001, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'project:testProject:edit', '#', 'admin',
        '2026-02-05 19:33:46', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2005, '测试项目删除', 2001, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'project:testProject:remove', '#',
        'admin', '2026-02-05 19:33:46', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2006, '测试项目导出', 2001, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'project:testProject:export', '#',
        'admin', '2026-02-05 19:33:46', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2020, '测试项目成员', 2001, 6, 'testProjectMember', 'project/testProjectMember/index', NULL, '', 1, 0, 'C', '1',
        '0', 'project:testProjectMember:list', '#', 'admin', '2026-03-26 19:39:58', '', NULL, '测试项目成员（隐藏）');
INSERT INTO `sys_menu`
VALUES (2021, '测试项目成员查询', 2020, 1, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectMember:query',
        '#', 'admin', '2026-03-26 19:39:58', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2022, '测试项目成员新增', 2020, 2, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectMember:add',
        '#', 'admin', '2026-03-26 19:39:58', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2023, '测试项目成员修改', 2020, 3, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectMember:edit',
        '#', 'admin', '2026-03-26 19:39:58', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2024, '测试项目成员删除', 2020, 4, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectMember:remove',
        '#', 'admin', '2026-03-26 19:39:58', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2025, '测试项目成员导出', 2020, 5, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectMember:export',
        '#', 'admin', '2026-03-26 19:39:58', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2026, '鉴权模板库', 2000, 2, 'testProjectTemplate', 'project/testProjectTemplate/index', NULL, '', 1, 0, 'C',
        '0', '0', 'project:testProjectTemplate:list', 'lock', 'admin', '2026-08-18 00:00:00', '', NULL,
        '鉴权模板库菜单');
INSERT INTO `sys_menu`
VALUES (2027, '鉴权模板查询', 2026, 1, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectTemplate:query',
        '#', 'admin', '2026-08-18 00:00:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2028, '鉴权模板新增', 2026, 2, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectTemplate:add', '#',
        'admin', '2026-08-18 00:00:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2029, '鉴权模板修改', 2026, 3, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectTemplate:edit',
        '#', 'admin', '2026-08-18 00:00:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2030, 'AI 管理', 0, 2, 'aiManages', NULL, NULL, '', 1, 0, 'M', '0', '0', '', 'ai-manage', 'admin',
        '2026-06-15 10:35:16', 'admin', '2026-06-18 21:52:27', '');
INSERT INTO `sys_menu`
VALUES (2031, 'AI 配置', 2030, 1, 'aiLlmVendor', 'ai/aiLlmVendor/index', NULL, '', 1, 0, 'C', '0', '0',
        'ai:aiLlmVendor:list', 'ai-vendor', 'admin', '2026-06-15 10:36:55', '', NULL, 'AI 大模型厂商菜单');
INSERT INTO `sys_menu`
VALUES (2032, 'AI 配置查询', 2031, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmVendor:query', '#', 'admin',
        '2026-06-15 10:36:55', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2033, 'AI 配置新增', 2031, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmVendor:add', '#', 'admin',
        '2026-06-15 10:36:55', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2034, 'AI 配置修改', 2031, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmVendor:edit', '#', 'admin',
        '2026-06-15 10:36:55', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2035, 'AI 配置删除', 2031, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmVendor:remove', '#', 'admin',
        '2026-06-15 10:36:55', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2036, 'AI 配置导出', 2031, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmVendor:export', '#', 'admin',
        '2026-06-15 10:36:55', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2037, 'AI 模型', 2030, 2, 'aiLlmModel', 'ai/aiLlmModel/index', NULL, '', 1, 0, 'C', '1', '0',
        'ai:aiLlmModel:list', '#', 'admin', '2026-06-15 10:37:23', 'admin', '2026-06-16 21:59:55', 'AI 大模型菜单');
INSERT INTO `sys_menu`
VALUES (2038, 'AI 模型查询', 2037, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmModel:query', '#', 'admin',
        '2026-06-15 10:37:23', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2039, 'AI 模型新增', 2037, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmModel:add', '#', 'admin',
        '2026-06-15 10:37:23', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2040, 'AI 模型修改', 2037, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmModel:edit', '#', 'admin',
        '2026-06-15 10:37:23', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2041, 'AI 模型删除', 2037, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmModel:remove', '#', 'admin',
        '2026-06-15 10:37:23', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2042, 'AI 模型导出', 2037, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiLlmModel:export', '#', 'admin',
        '2026-06-15 10:37:23', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2043, 'AI 会话', 2030, 3, 'aiChatSession', 'ai/aiChatSession/index', NULL, '', 1, 0, 'C', '0', '0',
        'ai:aiChatSession:list', 'ai-session', 'admin', '2026-06-15 10:37:43', '', NULL, 'AI 会话菜单');
INSERT INTO `sys_menu`
VALUES (2044, 'AI 会话查询', 2043, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatSession:query', '#', 'admin',
        '2026-06-15 10:37:43', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2045, 'AI 会话新增', 2043, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatSession:add', '#', 'admin',
        '2026-06-15 10:37:43', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2046, 'AI 会话修改', 2043, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatSession:edit', '#', 'admin',
        '2026-06-15 10:37:43', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2047, 'AI 会话删除', 2043, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatSession:remove', '#', 'admin',
        '2026-06-15 10:37:43', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2048, 'AI 会话导出', 2043, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatSession:export', '#', 'admin',
        '2026-06-15 10:37:43', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2049, 'AI 会话消息', 2030, 4, 'aiChatMessage', 'ai/aiChatMessage/index', NULL, '', 1, 0, 'C', '1', '0',
        'ai:aiChatMessage:list', '#', 'admin', '2026-06-15 10:38:00', 'admin', '2026-06-16 22:16:06',
        'AI 会话消息菜单');
INSERT INTO `sys_menu`
VALUES (2050, 'AI 会话消息查询', 2049, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatMessage:query', '#',
        'admin', '2026-06-15 10:38:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2051, 'AI 会话消息新增', 2049, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatMessage:add', '#', 'admin',
        '2026-06-15 10:38:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2052, 'AI 会话消息修改', 2049, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatMessage:edit', '#', 'admin',
        '2026-06-15 10:38:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2053, 'AI 会话消息删除', 2049, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatMessage:remove', '#',
        'admin', '2026-06-15 10:38:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2054, 'AI 会话消息导出', 2049, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiChatMessage:export', '#',
        'admin', '2026-06-15 10:38:00', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2055, 'AI 提示词', 2030, 3, 'aiPromptTemplate', 'ai/aiPromptTemplate/index', NULL, '', 1, 0, 'C', '0', '0',
        'ai:aiPromptTemplate:list', 'ai-prompt', 'admin', '2026-07-04 21:17:56', 'admin', '2026-07-05 09:08:32',
        'AI提示词模板菜单');
INSERT INTO `sys_menu`
VALUES (2056, 'AI 提示词模板查询', 2055, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiPromptTemplate:query', '#',
        'admin', '2026-07-04 21:17:56', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2057, 'AI 提示词模板新增', 2055, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiPromptTemplate:add', '#',
        'admin', '2026-07-04 21:17:56', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2058, 'AI 提示词模板修改', 2055, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiPromptTemplate:edit', '#',
        'admin', '2026-07-04 21:17:56', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2059, 'AI 提示词模板删除', 2055, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiPromptTemplate:remove', '#',
        'admin', '2026-07-04 21:17:56', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2060, 'AI 提示词模板导出', 2055, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ai:aiPromptTemplate:export', '#',
        'admin', '2026-07-04 21:17:56', '', NULL, '');
INSERT INTO `sys_menu`
VALUES (2061, '鉴权模板删除', 2026, 4, '#', NULL, NULL, '', 1, 0, 'F', '0', '0', 'project:testProjectTemplate:remove',
        '#', 'admin', '2026-08-18 00:00:00', '', NULL, '');
...
VALUES (1, '温馨提醒：2018-07-01 若依新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin',
        '2026-01-20 15:38:28', '', NULL, '管理员');
INSERT INTO `sys_notice`
VALUES (2, '维护通知：2018-07-01 若依系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2026-01-20 15:38:28',
        '', NULL, '管理员');
...
VALUES (1, 'ceo', '董事长', 1, '0', 'admin', '2026-01-20 15:38:22', '', NULL, '');
INSERT INTO `sys_post`
VALUES (2, 'se', '项目经理', 2, '0', 'admin', '2026-01-20 15:38:22', '', NULL, '');
INSERT INTO `sys_post`
VALUES (3, 'hr', '人力资源', 3, '0', 'admin', '2026-01-20 15:38:22', '', NULL, '');
INSERT INTO `sys_post`
VALUES (4, 'user', '普通员工', 4, '0', 'admin', '2026-01-20 15:38:22', '', NULL, '');
...
VALUES (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', 'admin', '2026-01-20 15:38:23', '', NULL, '超级管理员');
INSERT INTO `sys_role`
VALUES (2, '测试', 'test', 2, '2', 1, 1, '0', '0', 'admin', '2026-01-20 15:38:23', 'admin', '2026-03-31 11:11:29',
        '普通角色');
INSERT INTO `sys_role`
VALUES (3, '项目管理员', 'projectAdmin', 3, '1', 1, 1, '0', '2', 'admin', '2026-03-31 10:59:59', 'admin',
        '2026-03-31 11:00:05', NULL);
...
VALUES (1, 100, 'admin', '质衡', '00', 'qualitest@qq.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-07-19 21:40:21',
        '2026-01-20 15:38:21', 'admin', '2026-01-20 15:38:21', '', NULL, '管理员');
INSERT INTO `sys_user`
VALUES (2, 101, 'projectOwner', '项目所有者', '00', 'qualitest@168.com', '15666666666', '0', '',
        '$2a$10$8UPHu.laiE54ve4UF5S5N.Sa/PoRnBoepkq/leJc66oCmmy4F5G6a', '0', '0', '127.0.0.1', '2026-05-17 12:58:34',
        '2026-04-05 21:37:46', 'admin', '2026-01-20 15:38:22', 'admin', '2026-04-05 21:37:46', '测试员');
INSERT INTO `sys_user`
VALUES (3, 101, 'projectAdmin', '项目管理员', '00', '', '', '0', '',
        '$2a$10$pvJHoahgvDFy0VKnJZTyYe5kQZtBAq1UcKTPMbAKll2t.CdKKRFji', '0', '0', '127.0.0.1', '2026-04-07 16:48:35',
        '2026-04-05 21:42:33', 'admin', '2026-04-05 21:38:28', '', '2026-04-05 21:42:33', NULL);
INSERT INTO `sys_user`
VALUES (4, 101, 'projectDeveloper', '项目开发者', '00', '', '', '0', '',
        '$2a$10$5LlcFL/bNXSqnDjcC0MhWum4DTdQjP2zUJR8Dwbs7Wy7zXC/4BdfC', '0', '0', '127.0.0.1', '2026-04-06 11:02:28',
        NULL, 'admin', '2026-04-05 21:39:20', '', NULL, NULL);
INSERT INTO `sys_user`
VALUES (5, 101, 'projectTester', '项目测试员', '00', '', '', '0', '',
        '$2a$10$vOCx/EGDKdHRuDdbh7cEbe/5.LxrNNhKdo0h3ccKMw6IEDPoy0pGu', '0', '0', '127.0.0.1', '2026-04-06 11:02:38',
        '2026-04-05 21:45:03', 'admin', '2026-04-05 21:40:13', '', '2026-04-05 21:45:03', NULL);
...
(
    ...
    `test_value_config`   json                                                                          NULL COMMENT '测试值层',
    ...
    INDEX `idx_path_method` (`api_path` ASC) USING BTREE,
...
(
    ...
    `header_name`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '鉴权头名称',
    `header_value_template`    varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '鉴权头值模板',
    `match_config`             json                                                          NULL COMMENT '路径匹配',
...
VALUES (2100000000000000001, 'RuoYi Bearer', 'Authorization', 'Bearer {{flow.token}}', NULL, '[{"apiName":"登录","apiPath":"/login","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none","loginHint":{"expr":"$.token","from":"body","flowKey":"token"}},"designHints":{"hints":["token 在 $.token，不要写成 $.data.token"]},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"code":"","uuid":"","password":"","username":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]},"responseConfig":{"responses":[{"id":"resp-login","name":"成功","example":{"msg":"操作成功","code":200,"token":"..."},"httpStatus":200,"contentType":"json"}],"configVersion":1},"testValueConfig":{"request":{"bodyExample":{"password":"admin123","username":"admin"}}}},{"apiName":"注册","apiPath":"/register","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"password":"","username":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}},{"apiName":"验证码","apiPath":"/captchaImage","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"mode":"none"},"method":"GET","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}}]', 1, 1, 10, 'RuoYi Bearer', 0, '2026-08-19 10:54:45', NULL);
INSERT INTO `test_project_template`
VALUES (2100000000000000002, 'RuoYi Session', 'Cookie', 'JSESSIONID={{flow.jsessionId}}', NULL, '[{"apiName":"登录","apiPath":"/login","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none","loginHint":{"expr":"JSESSIONID","from":"setCookie","flowKey":"jsessionId"}},"designHints":{"hints":["Session 登录从 Set-Cookie 取 JSESSIONID"]},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"code":"","uuid":"","password":"","username":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]},"responseConfig":{"responses":[{"id":"resp-login","name":"成功","example":{"msg":"操作成功","code":200},"httpStatus":200,"contentType":"json"}],"configVersion":1},"testValueConfig":{"request":{"bodyExample":{"password":"admin123","username":"admin"}}}},{"apiName":"验证码","apiPath":"/captchaImage","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"mode":"none"},"method":"GET","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}},{"apiName":"验证码(旧)","apiPath":"/captcha/captchaImage","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"mode":"none"},"method":"GET","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}}]', 1, 1, 20, 'RuoYi 传统 Session', 0, '2026-08-19 10:54:45', NULL);
INSERT INTO `test_project_template`
VALUES (2100000000000000003, '客户端 Bearer', 'Authorization', 'Bearer {{flow.token}}', '{"pathPrefix":["/api/"]}', '[{"apiName":"登录","apiPath":"/api/account/auth/login","apiGroup":"客户端.账号","apiStatus":"normal","authConfig":{"mode":"none","loginHint":{"expr":"$.data.token","from":"body","flowKey":"token"}},"designHints":{"hints":["客户端 token 在 $.data.token，不要写成 $.token"]},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"mobile":"","password":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]},"responseConfig":{"responses":[{"id":"resp-login","name":"成功","example":{"msg":"操作成功","code":200,"data":{"token":"..."}},"httpStatus":200,"contentType":"json"}],"configVersion":1},"testValueConfig":{"request":{"bodyExample":{"mobile":"13800000001","password":"Test@123456"}}}},{"apiName":"注册","apiPath":"/api/account/auth/register","apiGroup":"客户端.账号","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"mobile":"","password":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}}]', 1, 1, 30, '商城 / 客户端 API', 0, '2026-08-19 10:54:45', NULL);
INSERT INTO `test_project_template`
VALUES (2100000000000000004, '管理端 Bearer', 'Authorization', 'Bearer {{flow.adminToken}}', '{"pathPrefix":["/system/","/monitor/","/tool/","/web/"]}', '[{"apiName":"登录","apiPath":"/login","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none","loginHint":{"expr":"$.token","from":"body","flowKey":"adminToken"}},"designHints":{"hints":["管理端 token 在 $.token → adminToken，不要写成 $.data.token"]},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"code":"","uuid":"","password":"","username":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]},"responseConfig":{"responses":[{"id":"resp-login","name":"成功","example":{"msg":"操作成功","code":200,"token":"..."},"httpStatus":200,"contentType":"json"}],"configVersion":1},"testValueConfig":{"request":{"bodyExample":{"password":"admin123","username":"admin"}}}},{"apiName":"注册","apiPath":"/register","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"json":{"example":{"password":"","username":""}},"mode":"json"},"method":"POST","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}},{"apiName":"验证码","apiPath":"/captchaImage","apiGroup":"系统.登录","apiStatus":"normal","authConfig":{"mode":"none"},"protocolType":"http","requestConfig":{"body":{"mode":"none"},"method":"GET","pathParams":[],"queryParams":[],"configVersion":1,"declaredHeaders":[]}}]', 1, 1, 40, 'RuoYi 管理端', 0, '2026-08-19 10:54:45', NULL);
