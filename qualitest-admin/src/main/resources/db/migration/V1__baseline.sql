...
-- ----------------------------
INSERT INTO `ai_prompt_template` VALUES (2070000000000000101, 'platform', NULL, 'test_flow_design', '从零搭建', '空画布或仅有 start', '搭建「{流程名称}」：\n1. {步骤描述}\n2. {步骤描述}\n\n需登录：业务主流用 Subflow 挂对应端已有登录流（管理端 adminAuth / 客户端 clientAuth），勿在主流重搭登录 HTTP；若本流就是登录子流，按端改用「搭建管理端登录子流」或「搭建客户端登录子流」。各步骤后加断言。须 submit_flow_design_patch。', 1, 1, 101, '从零搭建', 0, '2026-07-04 21:37:19', NULL);
