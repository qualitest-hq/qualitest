...
public class ProviderTemplate {
    ...
    /**
     * models.dev api.json 中的 provider 键；空则发现/解析时不按厂商精确命中
     */
    private String modelsDevProviderId;

    /**
     * 思考请求风格（写入上游请求体）；空则不写思考相关字段。
     * 取值见 {@link com.qualitest.ai.llm.ThinkingControlStyles}。
     */
