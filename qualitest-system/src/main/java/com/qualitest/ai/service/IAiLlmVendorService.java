 ...
 * @date 2026-06-15
 */
public interface IAiLlmVendorService {
    /**
     * 查询AI 厂商列表
     *
     ...
     * 批量删除AI 厂商
     * 
     * @param aiLlmVendorIdList 需要删除的AI 厂商主键集合
     * @return 结果
     */
    int deleteAiLlmVendorByIdList(List<Long> aiLlmVendorIdList);
     ...
     * 批量修改AI 厂商为逻辑删除
     *
     * @param aiLlmVendorIdList AI 厂商ID集合
     * @return 结果
     */
    int logicDeleteAiLlmVendorByIdList(List<Long> aiLlmVendorIdList);
