...
description: >-
  ...
  submit、create_flow、run_test_flow、项目 Token、允许 MCP 全自动写流，或要在 Cursor 里直接改质衡画布时使用。
---
...
2. **写流 / 跑流 / 新建流**前：质衡「项目设置」已开启并保存「允许 MCP 全自动写流」。未开则只能只读勘察。开启后若仍只见只读工具，请重连或刷新 MCP。
